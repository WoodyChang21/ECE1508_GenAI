...
### Skipped (low confidence or return too small) (`ctx_bars=70`, `start_idx=25006`)

![skipped](outputs/sample_plots/skipped_start25006_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 501.78 / 504.33 | 504.33 / 504.83 | 504.83 / 505.31 | 499.63 | — | — | **BENCHMARK** → sell 505.31 (**+1.14%**) |
| PatchTST | 498.67 / 498.79 | 500.00 / 498.98 | 500.45 / 500.35 | 499.63 | 500.35 | **NO TRADE** | — |
| CVAE | 499.55 / 499.71 | 499.87 / 499.95 | 499.67 / 499.84 | 499.63 | 499.75 | **NO TRADE** | — |

### No trade (target <= buy) (`ctx_bars=70`, `start_idx=25786`)

![no_trade](outputs/sample_plots/no_trade_start25786_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 570.28 / 568.69 | 567.71 / 568.36 | 568.33 / 569.52 | 570.26 | — | — | **BENCHMARK** → sell 569.52 (**−0.13%**) |
| PatchTST | 569.22 / 569.96 | 569.76 / 569.58 | 571.18 / 570.19 | 570.26 | 570.19 | **NO TRADE** | — |
| CVAE | 570.12 / 570.12 | 570.25 / 570.19 | 570.05 / 570.15 | 570.26 | 570.11 | **NO TRADE** | — |
...
|---|---|---|---|
| Skipped (low confidence or return too small) | 3.53 | 1.77 | 0.40 |
| No trade (target <= buy) | 2.57 | 1.96 | 0.20 |
...
| Case | PatchTST | CVAE |
|---|---|---|
| Win — take-profit hit | 5.7% | 0.0% |
| Win — expiry (gain) | 5.6% | 0.0% |
| Lose — expiry (loss) | 8.4% | 0.0% |
| Skipped (low confidence or return too small) | 75.9% | 86.8% |
| No trade (target <= buy) | 4.4% | 13.2% |
