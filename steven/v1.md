...
CVAE's win rate is high (88.3%), but its average loss runs ~7x its average win (avg win +0.09%, avg loss
-0.64% — a payoff ratio of ~0.14; PatchTST is healthier at ~0.64 but still loss-skewed). A single bad tail
...
Sweeping 0.5%–3% against the current backtest (both models, no quality gate on CVAE) found:
...
### Win — take-profit hit (`ctx_bars=70`, `start_idx=26643`)

![win_take_profit](outputs/sample_plots/win_take_profit_start26643_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 555.55 / 560.80 | 560.82 / 560.75 | 560.76 / 559.42 | 555.14 | — | — | **BENCHMARK** → sell 559.42 (**+0.77%**) |
| PatchTST | 556.41 / 558.03 | 556.34 / 555.09 | 556.17 / 554.94 | 555.14 | 558.03 | **NO TRADE** | — |
| CVAE | 555.00 / 555.17 | 555.53 / 555.72 | 555.25 / 555.62 | 555.14 | 555.37 | **ENTER** | **TAKE PROFIT** → sell 555.37 (**+0.04%**) |

### Lose — expiry (loss) (`ctx_bars=70`, `start_idx=25048`)

![lose_expiry](outputs/sample_plots/lose_expiry_start25048_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 501.38 / 500.79 | 500.82 / 500.84 | 500.84 / 501.05 | 502.04 | — | — | **BENCHMARK** → sell 501.05 (**−0.20%**) |
| PatchTST | 502.21 / 502.11 | 502.42 / 502.30 | 503.46 / 503.43 | 502.04 | 503.43 | **ENTER** | **EXPIRED** → sell 501.05 (**−0.20%**) |
| CVAE | 501.97 / 502.16 | 502.34 / 502.45 | 502.16 / 502.36 | 502.04 | 502.24 | **ENTER** | **EXPIRED** → sell 501.05 (**−0.20%**) |

### Lose — stop-loss hit (`ctx_bars=70`, `start_idx=26663`)

![lose_stop_loss](outputs/sample_plots/lose_stop_loss_start26663_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 523.73 / 516.28 | 516.28 / 516.36 | 516.36 / 512.39 | 537.67 | — | — | **BENCHMARK** → sell 512.39 (**−4.70%**) |
| PatchTST | 537.30 / 538.18 | 539.03 / 538.29 | 538.48 / 539.68 | 537.67 | 539.68 | **ENTER** | **STOP LOSS** → sell 523.73 (**−2.59%**) |
| CVAE | 537.60 / 537.75 | 538.04 / 538.19 | 537.67 / 537.99 | 537.67 | 537.81 | **ENTER** | **STOP LOSS** → sell 523.73 (**−2.59%**) |

### Skipped (quality gate or return too small) (`ctx_bars=70`, `start_idx=25644`)

![skipped](outputs/sample_plots/skipped_start25644_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 555.67 / 553.04 | 553.04 / 552.53 | 552.53 / 552.16 | 555.67 | — | — | **BENCHMARK** → sell 552.16 (**−0.63%**) |
| PatchTST | 555.54 / 555.03 | 557.46 / 557.81 | 557.22 / 558.13 | 555.67 | 558.13 | **NO TRADE** | — |
| CVAE | 555.72 / 555.72 | 555.82 / 555.74 | 555.66 / 555.76 | 555.67 | 555.73 | **NO TRADE** | — |

### No trade (target <= buy) (`ctx_bars=70`, `start_idx=25055`)

![no_trade](outputs/sample_plots/no_trade_start25055_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 504.15 / 502.02 | 502.02 / 502.13 | 502.13 / 502.29 | 500.25 | — | — | **BENCHMARK** → sell 502.29 (**+0.41%**) |
| PatchTST | 500.23 / 500.58 | 500.88 / 500.23 | 501.87 / 502.13 | 500.25 | 502.13 | **NO TRADE** | — |
| CVAE | 500.15 / 500.24 | 500.35 / 500.34 | 500.03 / 500.17 | 500.25 | 500.21 | **NO TRADE** | — |
...
| Lose — stop-loss hit | STOP LOSS | STOP LOSS |
...
|---|---|---|---|
| Win — take-profit hit | 5.27 | 3.09 | 0.72 |
| Lose — expiry (loss) | 0.59 | 1.34 | 0.48 |
| Lose — stop-loss hit | 11.34 | 2.38 | 0.59 |
| Skipped (quality gate or return too small) | 3.51 | 3.10 | 0.16 |
| No trade (target <= buy) | 2.13 | 1.90 | 0.32 |
...
| CVAE walk-forward | 684 | 88.3% | 88.3% | +0.010% | +6.79% | +4.91% |
...
| Case | PatchTST | CVAE |
|---|---|---|
| Win — take-profit hit | 12.9% | 58.6% |
| Win — expiry (gain) | 6.8% | 0.0% |
| Lose — expiry (loss) | 11.1% | 7.2% |
| Lose — stop-loss hit | 0.3% | 0.6% |
| Skipped (quality gate or return too small) | 64.3% | 19.8% |
| No trade (target <= buy) | 4.5% | 13.8% |
