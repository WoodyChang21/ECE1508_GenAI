...
### Win — take-profit hit (`ctx_bars=70`, `start_idx=25502`)

![win_take_profit](outputs/sample_plots/win_take_profit_start25502_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 519.67 / 523.57 | 523.55 / 519.66 | 519.64 / 518.95 | 519.68 | — | — | **BENCHMARK** → sell 518.95 (**−0.14%**) |
| PatchTST | 519.14 / 519.57 | 522.44 / 521.30 | 520.74 / 519.82 | 519.68 | 521.30 | **NO TRADE** | — |
| CVAE | 523.03 / 519.54 | 518.26 / 524.29 | 526.20 / 517.93 | 519.68 | 521.52 | **ENTER** | **TAKE PROFIT** → sell 521.52 (**+0.35%**) |

### Win — expiry (gain) (`ctx_bars=70`, `start_idx=25266`)

![win_expiry](outputs/sample_plots/win_expiry_start25266_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 540.88 / 541.43 | 541.46 / 541.12 | 541.11 / 542.10 | 540.87 | — | — | **BENCHMARK** → sell 542.10 (**+0.23%**) |
| PatchTST | 540.50 / 541.32 | 541.33 / 541.07 | 541.50 / 541.20 | 540.87 | 541.32 | **NO TRADE** | — |
| CVAE | 544.58 / 542.43 | 538.90 / 548.52 | 545.29 / 537.20 | 540.87 | 542.67 | **ENTER** | **EXPIRED** → sell 542.10 (**+0.23%**) |

### Lose — expiry (loss) (`ctx_bars=70`, `start_idx=26013`)

![lose_expiry](outputs/sample_plots/lose_expiry_start26013_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 587.23 / 585.47 | 585.47 / 585.43 | 585.38 / 584.09 | 587.24 | — | — | **BENCHMARK** → sell 584.09 (**−0.54%**) |
| PatchTST | 587.00 / 587.68 | 589.99 / 588.73 | 589.16 / 588.31 | 587.24 | 588.73 | **ENTER** | **EXPIRED** → sell 584.09 (**−0.54%**) |
| CVAE | 593.31 / 589.79 | 584.23 / 593.21 | 594.54 / 584.53 | 587.24 | 589.86 | **ENTER** | **EXPIRED** → sell 584.09 (**−0.54%**) |

### Skipped (low confidence or return too small) (`ctx_bars=70`, `start_idx=25754`)

![skipped](outputs/sample_plots/skipped_start25754_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 570.75 / 570.64 | 570.63 / 569.75 | 569.72 / 570.20 | 570.77 | — | — | **BENCHMARK** → sell 570.20 (**−0.10%**) |
| PatchTST | 571.32 / 571.88 | 573.48 / 572.77 | 571.77 / 572.11 | 570.77 | 572.77 | **ENTER** | **EXPIRED** → sell 570.20 (**−0.10%**) |
| CVAE | 571.67 / 569.77 | 566.83 / 576.69 | 575.19 / 566.84 | 570.77 | 571.13 | **NO TRADE** | — |

### No trade (target <= buy) (`ctx_bars=70`, `start_idx=25344`)

![no_trade](outputs/sample_plots/no_trade_start25344_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 546.06 / 545.84 | 545.84 / 546.66 | 546.66 / 547.73 | 546.06 | — | — | **BENCHMARK** → sell 547.73 (**+0.31%**) |
| PatchTST | 546.06 / 545.84 | 545.84 / 546.66 | 546.66 / 547.73 | 546.06 | — | *(not evaluated)* | — |
| CVAE | 546.84 / 542.85 | 542.41 / 551.41 | 549.37 / 541.67 | 546.06 | 545.73 | **NO TRADE** | — |
...
| Skipped (low confidence or return too small) | EXPIRED | NO TRADE |
| No trade (target <= buy) | NOT EVALUATED | NO TRADE |
...
|---|---|---|---|
| Win — take-profit hit | 4.62 | 3.30 | 8.27 |
| Win — expiry (gain) | 1.22 | 1.00 | 11.32 |
| Lose — expiry (loss) | 3.14 | 3.00 | 10.31 |
| Skipped (low confidence or return too small) | 1.03 | 2.16 | 9.87 |
| No trade (target <= buy) | 1.89 | 1.89 | 9.74 |
...
| CVAE walk-forward | 798 | 59.0% | 29.7% | +0.011% | +7.58% | +5.48% |
...
| Case | PatchTST | CVAE |
|---|---|---|
| Win — take-profit hit | 5.6% | 29.6% |
| Win — expiry (gain) | 5.8% | 29.2% |
| Lose — expiry (loss) | 8.4% | 40.8% |
| Skipped (low confidence or return too small) | 75.9% | 0.4% |
| No trade (target <= buy) | 4.4% | 0.1% |
