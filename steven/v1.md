...
### Sample 0 — short context (`ctx_bars=21`, `start_idx=26248`)

![sample0](outputs/sample_plots/sample0_start26248_ctx21.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | vs. real price |
|---|---|---|---|---|---|---|
| Ground truth | 600.97 / 601.79 | 601.79 / 601.25 | 597.54 / 593.21 | 600.90 | 599.43 | — |
| PatchTST | 635.62 / 696.81 | 599.54 / 603.62 | 591.88 / 617.56 | 600.90 | 624.17 | **MISSED** → sell 593.21 (**−1.28%**) |
| CVAE | 596.53 / 586.60 | 603.78 / 607.85 | 606.00 / 605.66 | 600.90 | 601.06 | **HIT** → sell 601.06 (**+0.03%**) |

### Sample 1 — long context (`ctx_bars=63`, `start_idx=26322`)

![sample1](outputs/sample_plots/sample1_start26322_ctx63.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | vs. real price |
|---|---|---|---|---|---|---|
| Ground truth | 607.50 / 607.17 | 607.17 / 607.99 | 608.00 / 607.66 | 607.51 | 607.58 | — |
| PatchTST | 638.28 / 678.86 | 605.87 / 611.84 | 575.43 / 583.43 | 607.51 | 615.62 | **MISSED** → sell 607.66 (**+0.02%**) |
| CVAE | 612.86 / 603.30 | 609.80 / 603.97 | 610.96 / 618.43 | 607.51 | 609.88 | **MISSED** → sell 607.66 (**+0.02%**) |

### Sample 2 — medium context (`ctx_bars=35`, `start_idx=24588`)

![sample2](outputs/sample_plots/sample2_start24588_ctx35.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | vs. real price |
|---|---|---|---|---|---|---|
| Ground truth | 478.85 / 479.35 | 479.38 / 480.96 | 480.95 / 481.97 | 478.85 | 480.24 | — |
| PatchTST | 475.00 / 521.74 | 475.94 / 453.69 | 467.40 / 453.56 | 478.85 | 474.56 | **MISSED** → sell 481.97 (**+0.65%**) |
| CVAE | 479.23 / 474.29 | 479.18 / 479.30 | 474.92 / 475.30 | 478.85 | 477.04 | **MISSED** → sell 481.97 (**+0.65%**) |

### Sample 3 — short context (`ctx_bars=28`, `start_idx=25951`)

![sample3](outputs/sample_plots/sample3_start25951_ctx28.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | vs. real price |
|---|---|---|---|---|---|---|
| Ground truth | 582.71 / 580.45 | 580.44 / 579.83 | 579.84 / 579.51 | 582.70 | 580.46 | — |
| PatchTST | 620.15 / 653.83 | 574.05 / 588.15 | 558.65 / 596.04 | 582.70 | 598.48 | **MISSED** → sell 579.51 (**−0.55%**) |
| CVAE | 584.54 / 579.13 | 580.06 / 580.36 | 579.53 / 582.78 | 582.70 | 581.07 | **HIT** → sell 581.07 (**−0.28%**) |

### Sample 4 — short context (`ctx_bars=14`, `start_idx=26357`)

![sample4](outputs/sample_plots/sample4_start26357_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | vs. real price |
|---|---|---|---|---|---|---|
| Ground truth | 600.77 / 601.58 | 601.58 / 602.59 | 602.60 / 602.37 | 600.78 | 601.91 | — |
| PatchTST | 604.56 / 668.71 | 575.90 / 536.03 | 575.85 / 557.03 | 600.78 | 586.35 | **MISSED** → sell 602.37 (**+0.26%**) |
| CVAE | 602.37 / 599.87 | 602.00 / 609.38 | 604.83 / 606.06 | 600.78 | 604.09 | **MISSED** → sell 602.37 (**+0.26%**) |
...
|---|---|---|---|---|---|
| 0.5 | 455 | 55.8% | 1.1% | +0.056% | +25.53% |
| 0.6 | 364 | 56.9% | 1.1% | +0.057% | +20.90% |
| 0.7 | 273 | 55.3% | 1.1% | +0.059% | +16.04% |
| 0.8 | 182 | 52.7% | 0.5% | +0.004% | +0.77% |
| 0.9 | 91 | 48.4% | 0.0% | −0.038% | −3.43% |

**CVAE**

| Confidence threshold | Trades taken | Win rate | Limit hit rate | Avg. return per trade | Total return |
|---|---|---|---|---|---|
| 0.5 | 1914 | 62.4% | 49.8% | +0.012% | +23.10% |
| 0.6 | 1914 | 62.4% | 49.8% | +0.012% | +23.10% |
| 0.7 | 1163 | 61.0% | 37.6% | +0.002% | +2.37% |
| 0.8 | 1163 | 61.0% | 37.6% | +0.002% | +2.37% |
| 0.9 | 411 | 58.2% | 28.5% | +0.010% | +4.25% |
