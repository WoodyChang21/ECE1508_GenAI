...
### Win — take-profit hit — narrow context (`ctx_bars=14`, `start_idx=25108`)

![win_take_profit_narrow](outputs/sample_plots/win_take_profit_narrow_start25108_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 500.73 / 503.06 | 503.07 / 506.47 | 506.48 / 500.25 | 500.72 | — | — | **BENCHMARK** → sell 500.25 (**−0.09%**) |
| PatchTST | 500.22 / 501.46 | 502.11 / 501.93 | 502.47 / 502.04 | 500.72 | 502.04 | **ENTER** | **TAKE PROFIT** → sell 502.04 (**+0.26%**) |
| CVAE | 499.23 / 502.27 | 503.04 / 502.78 | 505.42 / 508.47 | 500.72 | 503.42 | **ENTER** | **TAKE PROFIT** → sell 503.42 (**+0.54%**) |

### Win — take-profit hit — wide context (`ctx_bars=63`, `start_idx=25878`)

![win_take_profit_wide](outputs/sample_plots/win_take_profit_wide_start25878_ctx63.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 584.07 / 583.47 | 583.49 / 584.25 | 584.26 / 584.15 | 582.28 | — | — | **BENCHMARK** → sell 584.15 (**+0.32%**) |
| PatchTST | 582.17 / 582.79 | 583.45 / 583.16 | 583.47 / 583.53 | 582.28 | 583.53 | **ENTER** | **TAKE PROFIT** → sell 583.53 (**+0.22%**) |
| CVAE | 589.46 / 583.33 | 578.55 / 588.45 | 587.31 / 576.83 | 582.28 | 583.97 | **ENTER** | **TAKE PROFIT** → sell 583.97 (**+0.29%**) |

### Win — expiry (gain) — narrow context (`ctx_bars=14`, `start_idx=26149`)

![win_expiry_narrow](outputs/sample_plots/win_expiry_narrow_start26149_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 605.66 / 606.33 | 606.32 / 606.35 | 606.35 / 605.87 | 605.63 | — | — | **BENCHMARK** → sell 605.87 (**+0.04%**) |
| PatchTST | 605.47 / 606.86 | 607.78 / 607.19 | 607.44 / 607.15 | 605.63 | 607.19 | **ENTER** | **EXPIRED** → sell 605.87 (**+0.04%**) |
| CVAE | 606.08 / 607.60 | 608.07 / 602.89 | 612.01 / 611.13 | 605.63 | 607.96 | **ENTER** | **EXPIRED** → sell 605.87 (**+0.04%**) |

### Win — expiry (gain) — wide context (`ctx_bars=63`, `start_idx=24981`)

![win_expiry_wide](outputs/sample_plots/win_expiry_wide_start24981_ctx63.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 504.49 / 504.33 | 504.34 / 503.04 | 503.04 / 505.62 | 504.49 | — | — | **BENCHMARK** → sell 505.62 (**+0.22%**) |
| PatchTST | 503.22 / 504.61 | 505.77 / 505.78 | 506.17 / 505.82 | 504.49 | 505.82 | **ENTER** | **TAKE PROFIT** → sell 505.82 (**+0.26%**) |
| CVAE | 505.71 / 506.81 | 507.37 / 507.33 | 512.06 / 510.15 | 504.49 | 507.89 | **ENTER** | **EXPIRED** → sell 505.62 (**+0.22%**) |

### No trade (target <= buy) — narrow context (`ctx_bars=14`, `start_idx=24619`)

![no_trade_narrow](outputs/sample_plots/no_trade_narrow_start24619_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 483.62 / 484.10 | 484.11 / 483.52 | 484.01 / 483.85 | 483.61 | — | — | **BENCHMARK** → sell 483.85 (**+0.05%**) |
| PatchTST | 483.57 / 483.98 | 483.69 / 484.30 | 484.86 / 485.45 | 483.61 | 485.45 | **ENTER** | **EXPIRED** → sell 483.85 (**+0.05%**) |
| CVAE | 480.74 / 480.41 | 483.44 / 480.19 | 486.72 / 490.64 | 483.61 | 483.54 | **NO TRADE** | — |

### Lose — expiry (loss) — narrow context (`ctx_bars=21`, `start_idx=26551`)

![lose_expiry_narrow](outputs/sample_plots/lose_expiry_narrow_start26551_ctx21.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 579.44 / 574.51 | 574.52 / 572.96 | 572.99 / 577.86 | 583.97 | — | — | **BENCHMARK** → sell 577.86 (**−1.05%**) |
| PatchTST | 583.55 / 584.04 | 584.78 / 584.67 | 586.00 / 586.34 | 583.97 | 586.34 | **ENTER** | **EXPIRED** → sell 577.86 (**−1.05%**) |
| CVAE | 584.15 / 587.30 | 586.19 / 582.93 | 586.80 / 591.17 | 583.97 | 586.24 | **ENTER** | **EXPIRED** → sell 577.86 (**−1.05%**) |

### Lose — expiry (loss) — wide context (`ctx_bars=56`, `start_idx=24869`)

![lose_expiry_wide](outputs/sample_plots/lose_expiry_wide_start24869_ctx56.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 524.00 / 523.39 | 523.37 / 523.04 | 523.04 / 522.78 | 524.01 | — | — | **BENCHMARK** → sell 522.78 (**−0.23%**) |
| PatchTST | 524.25 / 525.24 | 525.85 / 524.88 | 524.86 / 525.09 | 524.01 | 525.24 | **ENTER** | **EXPIRED** → sell 522.78 (**−0.23%**) |
| CVAE | 526.91 / 529.18 | 526.40 / 522.52 | 531.06 / 525.72 | 524.01 | 526.95 | **ENTER** | **EXPIRED** → sell 522.78 (**−0.23%**) |
...
|---|---|---|---|---|
| Win — take-profit hit | narrow | 6.23 | 2.25 | 9.24 |
| Win — take-profit hit | wide | 0.79 | 1.37 | 12.63 |
| Win — expiry (gain) | narrow | 0.69 | 2.31 | 9.12 |
| Win — expiry (gain) | wide | 2.58 | 2.95 | 6.35 |
| No trade (target <= buy) | narrow | 0.59 | 1.88 | 10.45 |
| Lose — expiry (loss) | narrow | 6.48 | 2.79 | 8.24 |
| Lose — expiry (loss) | wide | 1.22 | 1.60 | 8.55 |
