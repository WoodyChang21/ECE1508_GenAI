...
### Win — take-profit hit — narrow context (`ctx_bars=14`, `start_idx=26424`)

![win_take_profit_narrow](outputs/sample_plots/win_take_profit_narrow_start26424_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 598.56 / 597.65 | 597.83 / 600.52 | 600.55 / 601.98 | 598.55 | — | — | **BENCHMARK** → sell 601.98 (**+0.57%**) |
| PatchTST | 597.50 / 598.74 | 598.96 / 599.53 | 599.92 / 599.88 | 598.55 | 599.88 | **ENTER** | **TAKE PROFIT** → sell 599.88 (**+0.22%**) |
| CVAE | 597.59 / 599.25 | 598.74 / 604.22 | 600.61 / 606.63 | 598.55 | 600.98 | **ENTER** | **TAKE PROFIT** → sell 600.98 (**+0.41%**) |

### Win — take-profit hit — wide context (`ctx_bars=70`, `start_idx=25464`)

![win_take_profit_wide](outputs/sample_plots/win_take_profit_wide_start25464_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 544.75 / 544.38 | 546.02 / 545.37 | 545.39 / 544.15 | 544.76 | — | — | **BENCHMARK** → sell 544.15 (**−0.11%**) |
| PatchTST | 543.06 / 543.14 | 544.89 / 546.56 | 545.17 / 544.60 | 544.76 | 546.56 | **ENTER** | **TAKE PROFIT** → sell 546.56 (**+0.33%**) |
| CVAE | 546.64 / 542.32 | 542.09 / 551.09 | 551.44 / 542.52 | 544.76 | 546.00 | **ENTER** | **TAKE PROFIT** → sell 546.00 (**+0.23%**) |

### Win — expiry (gain) — narrow context (`ctx_bars=21`, `start_idx=25753`)

![win_expiry_narrow](outputs/sample_plots/win_expiry_narrow_start25753_ctx21.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 561.46 / 560.83 | 560.82 / 561.39 | 561.38 / 561.72 | 561.48 | — | — | **BENCHMARK** → sell 561.72 (**+0.04%**) |
| PatchTST | 561.72 / 563.00 | 562.78 / 562.65 | 562.87 / 562.39 | 561.48 | 563.00 | **ENTER** | **EXPIRED** → sell 561.72 (**+0.04%**) |
| CVAE | 564.72 / 565.54 | 563.02 / 561.97 | 567.24 / 569.85 | 561.48 | 565.01 | **ENTER** | **EXPIRED** → sell 561.72 (**+0.04%**) |

### Win — expiry (gain) — wide context (`ctx_bars=56`, `start_idx=26250`)

![win_expiry_wide](outputs/sample_plots/win_expiry_wide_start26250_ctx56.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 596.27 / 598.89 | 598.91 / 599.51 | 599.49 / 598.57 | 591.87 | — | — | **BENCHMARK** → sell 598.57 (**+1.13%**) |
| PatchTST | 592.12 / 593.72 | 592.46 / 591.11 | 593.51 / 593.11 | 591.87 | 593.72 | **ENTER** | **EXPIRED** → sell 598.57 (**+1.13%**) |
| CVAE | 594.94 / 594.53 | 590.68 / 598.73 | 598.44 / 589.06 | 591.87 | 594.30 | **ENTER** | **EXPIRED** → sell 598.57 (**+1.13%**) |
...
### Lose — expiry (loss) — narrow context (`ctx_bars=28`, `start_idx=25530`)

![lose_expiry_narrow](outputs/sample_plots/lose_expiry_narrow_start25530_ctx28.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 546.11 / 545.03 | 545.05 / 542.30 | 542.30 / 540.26 | 546.17 | — | — | **BENCHMARK** → sell 540.26 (**−1.08%**) |
| PatchTST | 546.19 / 547.43 | 548.42 / 548.03 | 547.89 / 547.82 | 546.17 | 548.03 | **ENTER** | **EXPIRED** → sell 540.26 (**−1.08%**) |
| CVAE | 548.63 / 549.87 | 545.04 / 548.61 | 550.27 / 552.01 | 546.17 | 548.80 | **ENTER** | **EXPIRED** → sell 540.26 (**−1.08%**) |

### Lose — expiry (loss) — wide context (`ctx_bars=56`, `start_idx=25005`)

![lose_expiry_wide](outputs/sample_plots/lose_expiry_wide_start25005_ctx56.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 499.80 / 499.48 | 499.44 / 498.46 | 498.45 / 497.87 | 499.79 | — | — | **BENCHMARK** → sell 497.87 (**−0.38%**) |
| PatchTST | 499.16 / 499.50 | 498.96 / 499.78 | 499.80 / 499.06 | 499.79 | 499.78 | **NO TRADE** | — |
| CVAE | 499.33 / 500.91 | 500.12 / 502.62 | 501.73 / 502.62 | 499.79 | 501.16 | **ENTER** | **EXPIRED** → sell 497.87 (**−0.38%**) |
...
|---|---|---|---|---|
| Win — take-profit hit | narrow | 4.33 | 2.42 | 9.04 |
| Win — take-profit hit | wide | 1.87 | 3.50 | 9.35 |
| Win — expiry (gain) | narrow | 0.90 | 1.28 | 7.87 |
| Win — expiry (gain) | wide | 3.24 | 2.60 | 9.67 |
| No trade (target <= buy) | narrow | 2.11 | 2.19 | 15.92 |
| Lose — expiry (loss) | narrow | 5.85 | 2.23 | 6.97 |
| Lose — expiry (loss) | wide | 1.93 | 0.85 | 3.29 |
