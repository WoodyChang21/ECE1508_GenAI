...
### Win — take-profit hit (`ctx_bars=70`, `start_idx=26752`)

![win_take_profit](outputs/sample_plots/win_take_profit_start26752_ctx70.png)
...
| PatchTST | 535.60 / 535.42 | 536.30 / 537.72 | 536.50 / 537.85 | 536.55 | 537.85 | **NO TRADE** | — |
| CVAE | 543.39 / 535.92 | 532.39 / 542.20 | 543.00 / 533.00 | 536.55 | 538.30 | **ENTER** | **TAKE PROFIT** → sell 538.30 (**+0.33%**) |

### Win — expiry (gain) (`ctx_bars=70`, `start_idx=24903`)

![win_expiry](outputs/sample_plots/win_expiry_start24903_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 517.63 / 517.43 | 517.44 / 517.67 | 517.67 / 517.91 | 517.62 | — | — | **BENCHMARK** → sell 517.91 (**+0.06%**) |
| PatchTST | 517.36 / 518.00 | 519.93 / 519.02 | 519.51 / 518.82 | 517.62 | 519.02 | **ENTER** | **EXPIRED** → sell 517.91 (**+0.06%**) |
| CVAE | 520.31 / 516.98 | 516.93 / 521.13 | 525.11 / 516.40 | 517.62 | 519.32 | **ENTER** | **EXPIRED** → sell 517.91 (**+0.06%**) |

### Lose — expiry (loss) (`ctx_bars=70`, `start_idx=26890`)

![lose_expiry](outputs/sample_plots/lose_expiry_start26890_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 591.80 / 584.70 | 584.63 / 585.26 | 585.21 / 582.26 | 591.77 | — | — | **BENCHMARK** → sell 582.26 (**−1.61%**) |
| PatchTST | 589.88 / 590.53 | 595.03 / 593.87 | 593.12 / 592.68 | 591.77 | 593.87 | **NO TRADE** | — |
| CVAE | 590.83 / 590.76 | 592.27 / 594.44 | 596.16 / 594.16 | 591.77 | 592.93 | **ENTER** | **EXPIRED** → sell 582.26 (**−1.61%**) |

### Skipped (low confidence or return too small) (`ctx_bars=70`, `start_idx=26439`)

![skipped](outputs/sample_plots/skipped_start26439_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 610.08 / 610.06 | 610.30 / 611.18 | 611.11 / 611.05 | 611.35 | — | — | **BENCHMARK** → sell 611.05 (**−0.05%**) |
| PatchTST | 610.06 / 610.47 | 612.77 / 611.93 | 612.91 / 612.31 | 611.35 | 612.31 | **NO TRADE** | — |
| CVAE | 616.07 / 613.59 | 609.37 / 620.82 | 611.26 / 600.40 | 611.35 | 611.90 | **NO TRADE** | — |
...
| Win — expiry (gain) | EXPIRED | EXPIRED |
...
|---|---|---|---|
| Win — take-profit hit | 7.60 | 2.42 | 11.00 |
| Win — expiry (gain) | 0.48 | 2.56 | 8.72 |
| Lose — expiry (loss) | 9.54 | 5.15 | 5.40 |
| Skipped (low confidence or return too small) | 1.12 | 2.86 | 20.42 |
...
| PatchTST walk-forward | 339 | 57.5% | 28.9% | −0.010% | −3.71% | −2.73% |
| CVAE walk-forward | 798 | 59.0% | 33.5% | +0.008% | +5.40% | +3.92% |
...
| Case | PatchTST | CVAE |
|---|---|---|
| Win — take-profit hit | 5.7% | 33.3% |
| Win — expiry (gain) | 5.6% | 25.4% |
