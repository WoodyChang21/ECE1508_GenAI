...
### Win — take-profit hit — narrow context (`ctx_bars=14`, `start_idx=26421`)

![win_take_profit_narrow](outputs/sample_plots/win_take_profit_narrow_start26421_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 597.39 / 597.79 | 597.87 / 599.48 | 599.49 / 598.55 | 597.40 | — | — | **BENCHMARK** → sell 598.55 (**+0.19%**) |
| PatchTST | 597.47 / 598.52 | 599.38 / 599.20 | 599.76 / 599.37 | 597.40 | 599.37 | **ENTER** | **TAKE PROFIT** → sell 599.37 (**+0.33%**) |
| CVAE | 600.44 / 604.15 | 599.44 / 598.20 | 599.88 / 596.30 | 597.40 | 599.63 | **ENTER** | **TAKE PROFIT** → sell 599.63 (**+0.37%**) |

### Win — take-profit hit — wide context (`ctx_bars=70`, `start_idx=26752`)

![win_take_profit_wide](outputs/sample_plots/win_take_profit_wide_start26752_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 536.57 / 534.70 | 534.65 / 535.42 | 536.71 / 542.25 | 536.55 | — | — | **BENCHMARK** → sell 542.25 (**+1.06%**) |
| PatchTST | 535.60 / 535.42 | 536.30 / 537.72 | 536.50 / 537.85 | 536.55 | 537.85 | **ENTER** | **TAKE PROFIT** → sell 537.85 (**+0.24%**) |
| CVAE | 543.79 / 537.19 | 532.53 / 542.51 | 543.97 / 533.81 | 536.55 | 538.85 | **ENTER** | **TAKE PROFIT** → sell 538.85 (**+0.43%**) |

### Win — expiry (gain) — narrow context (`ctx_bars=28`, `start_idx=25760`)

![win_expiry_narrow](outputs/sample_plots/win_expiry_narrow_start25760_ctx28.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 563.12 / 562.76 | 562.75 / 563.00 | 563.02 / 563.72 | 563.13 | — | — | **BENCHMARK** → sell 563.72 (**+0.10%**) |
| PatchTST | 562.77 / 563.89 | 564.43 / 564.53 | 564.88 / 564.98 | 563.13 | 564.98 | **ENTER** | **EXPIRED** → sell 563.72 (**+0.10%**) |
| CVAE | 566.30 / 569.26 | 563.04 / 562.85 | 566.54 / 566.17 | 563.13 | 565.49 | **ENTER** | **EXPIRED** → sell 563.72 (**+0.10%**) |

### Win — expiry (gain) — wide context (`ctx_bars=63`, `start_idx=24744`)

![win_expiry_wide](outputs/sample_plots/win_expiry_wide_start24744_ctx63.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 505.23 / 506.31 | 506.31 / 506.76 | 506.75 / 506.87 | 505.22 | — | — | **BENCHMARK** → sell 506.87 (**+0.33%**) |
| PatchTST | 505.07 / 505.37 | 506.91 / 506.81 | 506.80 / 507.82 | 505.22 | 507.82 | **ENTER** | **EXPIRED** → sell 506.87 (**+0.33%**) |
| CVAE | 508.26 / 505.72 | 505.04 / 506.89 | 511.67 / 506.57 | 505.22 | 507.29 | **ENTER** | **EXPIRED** → sell 506.87 (**+0.33%**) |
...
### Lose — expiry (loss) — narrow context (`ctx_bars=14`, `start_idx=26836`)

![lose_expiry_narrow](outputs/sample_plots/lose_expiry_narrow_start26836_ctx14.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 554.90 / 554.60 | 554.65 / 554.16 | 547.57 / 546.31 | 554.85 | — | — | **BENCHMARK** → sell 546.31 (**−1.54%**) |
| PatchTST | 553.78 / 554.59 | 555.83 / 555.50 | 556.79 / 556.26 | 554.85 | 556.26 | **ENTER** | **EXPIRED** → sell 546.31 (**−1.54%**) |
| CVAE | 553.43 / 554.72 | 557.35 / 555.03 | 561.90 / 563.75 | 554.85 | 557.54 | **ENTER** | **EXPIRED** → sell 546.31 (**−1.54%**) |

### Lose — expiry (loss) — wide context (`ctx_bars=70`, `start_idx=24863`)

![lose_expiry_wide](outputs/sample_plots/lose_expiry_wide_start24863_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 522.04 / 522.51 | 522.51 / 521.69 | 521.70 / 521.27 | 522.04 | — | — | **BENCHMARK** → sell 521.27 (**−0.15%**) |
| PatchTST | 521.35 / 522.34 | 523.30 / 523.67 | 523.54 / 524.41 | 522.04 | 524.41 | **ENTER** | **EXPIRED** → sell 521.27 (**−0.15%**) |
| CVAE | 521.77 / 521.19 | 521.21 / 525.48 | 529.26 / 524.22 | 522.04 | 523.82 | **ENTER** | **EXPIRED** → sell 521.27 (**−0.15%**) |
...
|---|---|---|---|---|
| Win — take-profit hit | narrow | 2.10 | 2.28 | 7.84 |
| Win — take-profit hit | wide | 7.60 | 2.42 | 11.44 |
| Win — expiry (gain) | narrow | 0.97 | 2.21 | 6.41 |
| Win — expiry (gain) | wide | 1.64 | 2.75 | 6.63 |
| No trade (target <= buy) | narrow | 2.11 | 2.19 | 15.92 |
| Lose — expiry (loss) | narrow | 8.59 | 3.01 | 10.33 |
| Lose — expiry (loss) | wide | 1.24 | 3.06 | 8.08 |
