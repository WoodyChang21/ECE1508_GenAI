...
### Win — take-profit hit (`ctx_bars=70`, `start_idx=26467`)

![win_take_profit](outputs/sample_plots/win_take_profit_start26467_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 597.15 / 590.85 | 590.75 / 590.87 | 590.85 / 593.68 | 597.19 | — | — | **BENCHMARK** → sell 593.68 (**−0.59%**) |
| PatchTST | 596.50 / 596.18 | 598.38 / 597.19 | 597.29 / 596.74 | 597.19 | 597.19 | **NO TRADE** | — |
| CVAE | 596.97 / 597.47 | 598.21 / 598.08 | 597.98 / 596.87 | 597.19 | 597.59 | **ENTER** | **TAKE PROFIT** → sell 597.59 (**+0.07%**) |

### Win — expiry (gain) (`ctx_bars=70`, `start_idx=24748`)

![win_expiry](outputs/sample_plots/win_expiry_start24748_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 507.69 / 507.19 | 507.18 / 506.58 | 506.58 / 507.75 | 507.71 | — | — | **BENCHMARK** → sell 507.75 (**+0.01%**) |
| PatchTST | 507.01 / 507.57 | 509.16 / 509.09 | 509.32 / 509.24 | 507.71 | 509.24 | **NO TRADE** | — |
| CVAE | 507.64 / 508.00 | 508.42 / 508.14 | 508.12 / 507.32 | 507.71 | 507.91 | **ENTER** | **EXPIRED** → sell 507.75 (**+0.01%**) |

### Lose — expiry (loss) (`ctx_bars=70`, `start_idx=24576`)

![lose_expiry](outputs/sample_plots/lose_expiry_start24576_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 488.03 / 486.22 | 486.22 / 485.51 | 485.52 / 485.32 | 488.03 | — | — | **BENCHMARK** → sell 485.32 (**−0.56%**) |
| PatchTST | 487.51 / 488.34 | 489.34 / 488.91 | 489.52 / 489.98 | 488.03 | 489.98 | **ENTER** | **EXPIRED** → sell 485.32 (**−0.56%**) |
| CVAE | 488.05 / 488.32 | 488.57 / 488.38 | 488.37 / 487.63 | 488.03 | 488.21 | **ENTER** | **EXPIRED** → sell 485.32 (**−0.56%**) |

### Lose — stop-loss hit (`ctx_bars=70`, `start_idx=26722`)

![lose_stop_loss](outputs/sample_plots/lose_stop_loss_start26722_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 531.50 / 531.53 | 531.55 / 526.00 | 526.00 / 520.63 | 531.51 | — | — | **BENCHMARK** → sell 520.63 (**−2.05%**) |
| PatchTST | 529.66 / 530.44 | 532.80 / 531.95 | 532.48 / 531.38 | 531.51 | 531.95 | **NO TRADE** | — |
| CVAE | 531.18 / 531.81 | 532.87 / 533.10 | 532.65 / 531.35 | 531.51 | 532.13 | **ENTER** | **STOP LOSS** → sell 520.88 (**−2.00%**) |

### Skipped (quality gate or return too small) (`ctx_bars=70`, `start_idx=24633`)

![skipped](outputs/sample_plots/skipped_start24633_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Take-profit | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 493.47 / 493.67 | 493.66 / 492.58 | 493.52 / 492.50 | 493.48 | — | — | **BENCHMARK** → sell 492.50 (**−0.20%**) |
| PatchTST | 493.28 / 493.18 | 493.17 / 494.13 | 494.13 / 493.16 | 493.48 | 494.13 | **NO TRADE** | — |
| CVAE | 493.37 / 493.66 | 493.90 / 493.65 | 493.75 / 493.09 | 493.48 | 493.57 | **NO TRADE** | — |
...
| Lose — expiry (loss) | EXPIRED | EXPIRED |
| Lose — stop-loss hit | NO TRADE | STOP LOSS |
| Skipped (quality gate or return too small) | NO TRADE | NO TRADE |
...
|---|---|---|---|
| Win — take-profit hit | 6.40 | 2.20 | 1.34 |
| Win — expiry (gain) | 1.17 | 2.32 | 1.10 |
| Lose — expiry (loss) | 2.71 | 2.46 | 0.94 |
| Lose — stop-loss hit | 10.92 | 3.14 | 1.93 |
| Skipped (quality gate or return too small) | 1.17 | 0.97 | 0.81 |
...
| CVAE walk-forward | 799 | 84.2% | 83.9% | −0.004% | −3.84% | −2.82% |
...
| Case | PatchTST | CVAE |
|---|---|---|
| Win — take-profit hit | 12.9% | 83.8% |
| Win — expiry (gain) | 6.8% | 0.4% |
| Lose — expiry (loss) | 11.1% | 15.1% |
| Lose — stop-loss hit | 0.3% | 0.6% |
| Skipped (quality gate or return too small) | 64.3% | 0.1% |
