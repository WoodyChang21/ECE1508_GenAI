...
### Sample 0 — long context (`ctx_bars=63`, `start_idx=26862`)

![sample0](outputs/sample_plots/sample0_start26862_ctx63.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 587.95 / 586.33 | 586.32 / 586.86 | 586.87 / 586.99 | 587.91 | 586.89 | — | — |
| PatchTST | 599.21 / 610.71 | 577.70 / 588.81 | 576.83 / 587.91 | 587.91 | 590.19 | **ENTER** | **MISSED** → sell 586.99 (**−0.16%**) |
| CVAE | 591.31 / 592.44 | 589.32 / 589.10 | 586.63 / 585.43 | 587.91 | 589.04 | **ENTER** | **MISSED** → sell 586.99 (**−0.16%**) |

### Sample 1 — long context (`ctx_bars=70`, `start_idx=25056`)

![sample1](outputs/sample_plots/sample1_start25056_ctx70.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 502.02 / 502.13 | 502.13 / 502.29 | 502.29 / 504.12 | 502.02 | 502.50 | — | — |
| PatchTST | 498.83 / 490.45 | 499.58 / 504.95 | 492.58 / 483.47 | 502.02 | 494.98 | **NO TRADE** | **MISSED** → sell 504.12 (**+0.42%**) |
| CVAE | 505.86 / 501.73 | 496.96 / 501.96 | 503.16 / 507.35 | 502.02 | 502.84 | **ENTER** | **HIT** → sell 502.84 (**+0.16%**) |

### Sample 2 — medium context (`ctx_bars=42`, `start_idx=24702`)

![sample2](outputs/sample_plots/sample2_start24702_ctx42.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 494.23 / 492.11 | 492.10 / 491.33 | 491.33 / 494.14 | 494.23 | 492.54 | — | — |
| PatchTST | 503.73 / 494.30 | 485.06 / 494.38 | 484.92 / 494.14 | 494.23 | 492.75 | **NO TRADE** | **HIT** → sell 492.75 (**−0.30%**) |
| CVAE | 497.81 / 497.50 | 492.57 / 495.74 | 496.49 / 497.31 | 494.23 | 496.24 | **ENTER** | **MISSED** → sell 494.14 (**−0.02%**) |

### Sample 3 — short context (`ctx_bars=28`, `start_idx=25415`)

![sample3](outputs/sample_plots/sample3_start25415_ctx28.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 555.78 / 555.85 | 557.07 / 557.36 | 557.34 / 557.68 | 555.79 | 556.85 | — | — |
| PatchTST | 566.47 / 576.99 | 565.85 / 555.25 | 545.36 / 555.83 | 555.79 | 560.96 | **ENTER** | **MISSED** → sell 557.68 (**+0.34%**) |
| CVAE | 556.99 / 555.41 | 556.98 / 560.43 | 553.33 / 550.27 | 555.79 | 555.57 | **NO TRADE** | **HIT** → sell 555.57 (**−0.04%**) |

### Sample 4 — long context (`ctx_bars=56`, `start_idx=24647`)

![sample4](outputs/sample_plots/sample4_start24647_ctx56.png)

| | Candle 1 (open / close) | Candle 2 (open / close) | Candle 3 (open / close) | Buy price | Target price | Trade? | vs. real price |
|---|---|---|---|---|---|---|---|
| Ground truth | 493.47 / 493.67 | 493.66 / 492.58 | 493.52 / 492.50 | 493.48 | 493.23 | — | — |
| PatchTST | 497.66 / 492.59 | 502.35 / 511.49 | 484.90 / 494.22 | 493.48 | 497.20 | **ENTER** | **MISSED** → sell 492.50 (**−0.20%**) |
| CVAE | 497.12 / 502.42 | 492.03 / 496.17 | 494.56 / 496.11 | 493.48 | 496.40 | **ENTER** | **MISSED** → sell 492.50 (**−0.20%**) |
...
| Confidence threshold | Trades taken | Win rate | Limit hit rate | Avg. return per trade | Total return |
|---|---|---|---|---|---|
| 0.5 | 1964 | 65.4% | 54.9% | +0.024% | +47.92% |
| 0.6 | 1964 | 65.4% | 54.9% | +0.024% | +47.92% |
| 0.7 | 1173 | 64.0% | 42.9% | +0.030% | +35.45% |
| 0.8 | 1173 | 64.0% | 42.9% | +0.030% | +35.45% |
| 0.9 | 481 | 59.0% | 28.9% | +0.039% | +18.67% |
